...
If the interaction effect is non-zero, the interpretation of the coefficients changes. Let us explain this table further, firstly be looking at `sexFemale`. In this case we expect a base rate of `r model4a$coefficients[1]` units of wage plus `r model4a$coefficients[3]` for each additional year of age. For the case of `sexMale` we have a reduction of the base rate equal to `r model4a$coefficients[2]`, but this is _more_ than compensated for by the additional increase in pay for each year of age, `r model4a$coefficients[4]`.
